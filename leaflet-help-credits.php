...
if (basename($_SERVER['SCRIPT_FILENAME']) == 'leaflet-help-credits.php') { die ("Please do not access this file directly. Thanks!<br/><a href='https://www.mapsmarker.com/go'>www.mapsmarker.com</a>"); }
	...
	<p>
	<h1><?php _e('Help','leaflet-maps-marker') ?></h1>
	<p>
		<?php _e('If you have any questions or experienced issues, please use the following support channels appropriately.','leaflet-maps-marker') ?>
	</p>
	<p>
		<strong><?php _e('One personal request: before you post a new support ticket in the <a href="http://wordpress.org/support/plugin/leaflet-maps-marker" target="_blank">Wordpress Support Forum</a>, please follow the instructions from <a href="http://www.mapsmarker.com/readme-first" target="_blank">http://www.mapsmarker.com/readme-first</a> which give you a guideline on how to deal with the most common issues.','leaflet-maps-marker') ?></strong>
	</p>
	<ul>
		<li>- <a href="https://www.mapsmarker.com/faq/" target="_blank"><?php _e('FAQ','leaflet-maps-marker') ?></a>	<?php _e('(frequently asked questions)','leaflet-maps-marker') ?></li>
		<li>- <a href="https://www.mapsmarker.com/docs/" target="_blank"><?php _e('Documentation','leaflet-maps-marker') ?></a></li>
		<li>- <a href="https://www.mapsmarker.com/docs/changelog/" target="_blank"><?php _e('Changelog','leaflet-maps-marker') ?></a></li>
		<li>- <a href="https://wordpress.org/support/plugin/leaflet-maps-marker" target="_blank">WordPress Support Forum</a> (<?php _e('free community support','leaflet-maps-marker') ?>)</li>
	</ul>
	<p>
		<a style="background:#f99755;display:block;padding:5px 5px 5px 10px;text-decoration:none;color:#2702c6;margin:10px 0;" href="<?php echo LEAFLET_WP_ADMIN_URL; ?>admin.php?page=leafletmapsmarker_pro_upgrade"><?php _e('If you want to get dedicated 1:1 support from the plugin author, please upgrade to the pro version. Click here to find out how you can start a free 30-day-trial easily','leaflet-maps-marker'); ?></a>
	</p>
	<h2><?php _e('License','leaflet-maps-marker') ?></h2>
	<p>
		<?php _e('Good news, this plugin is free for everyone! Since it is released under the GPL2, you can use it free of charge on your personal or commercial blog.<br/>Anyway if you enjoy using this plugin, please consider upgrading to the pro version.','leaflet-maps-marker') ?>
	</p>
	<h2><?php _e('Trademarks and copyright','leaflet-maps-marker') ?></h2>
	<p>
	MapsMarker<sup style="font-size:75%;">&reg;</sup><br/>
	Copyright &copy; 2011-<?php echo date('Y'); ?>, MapsMarker.com e.U., All Rights Reserved
	</p>
	<h2><?php _e('Translations','leaflet-maps-marker') ?></h2>
	<p>
	<?php
	$translation_website = '<a href="https://translate.mapsmarker.com/" target="_blank">https://translate.mapsmarker.com/</a>';
	$translation_output = sprintf(__('Adding a new translation or updating an existing one is quite easy - please visit %s for more information!','leaflet-maps-marker'),$translation_website);
	...
	<h2><?php _e('Licenses for used libraries, services and images','leaflet-maps-marker') ?></h2>
	<ul>
